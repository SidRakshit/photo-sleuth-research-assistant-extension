...
!(function (e, t) {
	...
	var J = (function t() {
		...
		let tt = null;
		const nt = ["application/xhtml+xml", "text/html"],
			ot = "text/html";
		let rt = null,
			it = null;
		const at = r.createElement("form"),
			lt = function (e) {
			...
			ct = function () {
				...
				if (!it || it !== e) {
					if (
						...
						(e = w(e)),
						(tt =
							-1 === nt.indexOf(e.PARSER_MEDIA_TYPE)
								? ot
								: e.PARSER_MEDIA_TYPE),
						(rt = "application/xhtml+xml" === tt ? d : f),
						(Te = E(e, "ALLOWED_TAGS") ? S({}, e.ALLOWED_TAGS, rt) : ye),
						(Ee = E(e, "ALLOWED_ATTR") ? S({}, e.ALLOWED_ATTR, rt) : Ae),
						(Qe = E(e, "ALLOWED_NAMESPACES")
							? S({}, e.ALLOWED_NAMESPACES, d)
							: et),
						(Xe = E(e, "ADD_URI_SAFE_ATTR")
							? S(w(qe), e.ADD_URI_SAFE_ATTR, rt)
							: qe),
						(Ye = E(e, "ADD_DATA_URI_TAGS")
							? S(w(je), e.ADD_DATA_URI_TAGS, rt)
							: je),
						(We = E(e, "FORBID_CONTENTS") ? S({}, e.FORBID_CONTENTS, rt) : Ge),
						(Ne = E(e, "FORBID_TAGS") ? S({}, e.FORBID_TAGS, rt) : {}),
						(be = E(e, "FORBID_ATTR") ? S({}, e.FORBID_ATTR, rt) : {}),
						(Be = !!E(e, "USE_PROFILES") && e.USE_PROFILES),
						(Se = !1 !== e.ALLOW_ARIA_ATTR),
						(Re = !1 !== e.ALLOW_DATA_ATTR),
						(we = e.ALLOW_UNKNOWN_PROTOCOLS || !1),
						...
						(He = !1 !== e.KEEP_CONTENT),
						(ze = e.IN_PLACE || !1),
						(ge = e.ALLOWED_URI_REGEXP || Y),
						(Ze = e.NAMESPACE || Ve),
						(_e = e.CUSTOM_ELEMENT_HANDLING || {}),
						e.CUSTOM_ELEMENT_HANDLING &&
							lt(e.CUSTOM_ELEMENT_HANDLING.tagNameCheck) &&
							(_e.tagNameCheck = e.CUSTOM_ELEMENT_HANDLING.tagNameCheck),
						e.CUSTOM_ELEMENT_HANDLING &&
						...
						Be &&
							((Te = S({}, M)),
							(Ee = []),
							!0 === Be.html && (S(Te, D), S(Ee, I)),
							!0 === Be.svg && (S(Te, C), S(Ee, U), S(Ee, F)),
							!0 === Be.svgFilters && (S(Te, O), S(Ee, U), S(Ee, F)),
							!0 === Be.mathMl && (S(Te, v), S(Ee, P), S(Ee, F))),
						e.ADD_TAGS && (Te === ye && (Te = w(Te)), S(Te, e.ADD_TAGS, rt)),
						e.ADD_ATTR && (Ee === Ae && (Ee = w(Ee)), S(Ee, e.ADD_ATTR, rt)),
						e.ADD_URI_SAFE_ATTR && S(Xe, e.ADD_URI_SAFE_ATTR, rt),
						e.FORBID_CONTENTS &&
							(We === Ge && (We = w(We)), S(We, e.FORBID_CONTENTS, rt)),
						He && (Te["#text"] = !0),
						Oe && S(Te, ["html", "head", "body"]),
						Te.table && (S(Te, ["tbody"]), delete Ne.tbody),
						...
						void 0 === ee && (ee = Z(G, c)),
							null !== ee && "string" == typeof te && (te = ee.createHTML(""));
					i && i(e), (it = e);
				}
			},
			st = S({}, ["mi", "mo", "mn", "ms", "mtext"]),
			ut = S({}, ["foreignobject", "desc", "title", "annotation-xml"]),
				...
				return (
					...
					(e.namespaceURI === Ke
						...
						? t.namespaceURI === Ve
							...
							: Boolean(ft[n])
						: e.namespaceURI === Ve
						? !(t.namespaceURI === Ke && !ut[o]) &&
						  !(t.namespaceURI === $e && !st[o]) &&
						  !ft[n] &&
						  (mt[n] || !pt[n])
			...
			Tt = function (e) {
				...
				"application/xhtml+xml" === tt &&
					...
					(e =
						...
						e +
						"</body></html>");
				const o = ee ? ee.createHTML(e) : e;
				if (Ze === Ve)
					try {
						t = new W().parseFromString(o, tt);
					} catch (e) {}
				if (!t || !t.documentElement) {
					t = ne.createDocument(Ze, "template", null);
					try {
						t.documentElement.innerHTML = Je ? te : o;
					} catch (e) {}
				}
			...
			Nt = function (e) {
				let t = null;
				if ((_t("beforeSanitizeElements", e, null), Et(e))) return ht(e), !0;
				const n = rt(e.nodeName);
				if (
					(_t("uponSanitizeElement", e, { tagName: n, allowedTags: Te }),
					e.hasChildNodes() &&
					...
					return ht(e), !0;
				if (7 === e.nodeType) return ht(e), !0;
				if (Ce && 8 === e.nodeType && A(/<[/\w]/g, e.data)) return ht(e), !0;
				if (!Te[n] || Ne[n]) {
					if (!Ne[n] && St(n)) {
						if (_e.tagNameCheck instanceof RegExp && A(_e.tagNameCheck, n))
							return !1;
						if (_e.tagNameCheck instanceof Function && _e.tagNameCheck(n))
							return !1;
					}
					if (He && !We[n]) {
						...
						if (n && t) {
							for (let o = n.length - 1; o >= 0; --o)
								t.insertBefore(X(n[o], !0), $(e));
						}
					}
					return ht(e), !0;
				}
				return e instanceof R && !dt(e)
					? (ht(e), !0)
					...
					? (De &&
							...
							e.textContent !== t &&
								...
								(e.textContent = t))),
					  _t("afterSanitizeElements", e, null),
					  !1)
					: (ht(e), !0);
			},
			bt = function (e, t, n) {
				if (Ue && ("id" === t || "name" === t) && (n in r || n in at))
					return !1;
				if (Re && !be[t] && A(me, t));
				else if (Se && A(pe, t));
				else if (!Ee[t] || be[t]) {
					if (
						!(
							(St(e) &&
								((_e.tagNameCheck instanceof RegExp && A(_e.tagNameCheck, e)) ||
									(_e.tagNameCheck instanceof Function &&
										_e.tagNameCheck(e))) &&
								((_e.attributeNameCheck instanceof RegExp &&
									A(_e.attributeNameCheck, t)) ||
									(_e.attributeNameCheck instanceof Function &&
										_e.attributeNameCheck(t)))) ||
							("is" === t &&
								_e.allowCustomizedBuiltInElements &&
								((_e.tagNameCheck instanceof RegExp && A(_e.tagNameCheck, n)) ||
									(_e.tagNameCheck instanceof Function && _e.tagNameCheck(n))))
						)
					)
						return !1;
				} else if (Xe[t]);
			...
			Rt = function (e) {
				_t("beforeSanitizeAttributes", e, null);
				...
				for (; r--; ) {
					...
					if (
						...
						_t("uponSanitizeAttribute", e, n),
						(p = n.attrValue),
						n.forceKeepAttr)
					)
						continue;
					if ((gt(a, e), !n.keepAttr)) continue;
					if (!Le && A(/\/>/i, p)) {
						gt(a, e);
						continue;
					}
				...
				_t("afterSanitizeAttributes", e, null);
			},
			wt = function e(t) {
				let n = null;
				const o = yt(t);
				for (_t("beforeSanitizeShadowDOM", t, null); (n = o.nextNode()); )
					_t("uponSanitizeShadowNode", n, null),
						Nt(n) || (n.content instanceof s && e(n.content), Rt(n));
				_t("afterSanitizeShadowDOM", t, null);
			};
		return (
			(o.sanitize = function (e) {
				let t =
					...
					l = null;
				if (
					((Je = !e), Je && (e = "\x3c!--\x3e"), "string" != typeof e && !At(e))
				) {
				...
				if (
					(xe || ct(t), (o.removed = []), "string" == typeof e && (ze = !1), ze)
				) {
					if (e.nodeName) {
					...
					if (!ke && !De && !Oe && -1 === e.indexOf("<"))
						return ee && Ie ? ee.createHTML(e) : e;
					if (((n = Tt(e)), !n)) return ke ? null : Ie ? te : "";
				}
				n && ve && ht(n.firstChild);
				const c = yt(ze ? e : n);
				for (; (i = c.nextNode()); )
					Nt(i) || (i.content instanceof s && wt(i.content), Rt(i));
				if (ze) return e;
				if (ke) {
					if (Me)
						for (l = re.call(n.ownerDocument); n.firstChild; )
							l.appendChild(n.firstChild);
					else l = n;
					return (
						(Ee.shadowroot || Ee.shadowrootmode) && (l = ae.call(a, l, !0)), l
					);
				}
				let m = Oe ? n.outerHTML : n.innerHTML;
				return (
					Oe &&
						Te["!doctype"] &&
						n.ownerDocument &&
						...
						A(q, n.ownerDocument.doctype.name) &&
